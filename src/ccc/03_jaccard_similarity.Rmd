...
# filter for AD
group_oi <- "X6mAD"
lrt_cor_filtered_1 <- filter_nichenet(output) # 225

group_oi <- "X12mAD"
lrt_cor_filtered_2 <- filter_nichenet(output) # 1788

# filter for WT
group_oi <- "X6mWT"
lrt_cor_filtered_3 <- filter_nichenet(output) # 110

group_oi <- "X12mWT"
lrt_cor_filtered_4 <- filter_nichenet(output) # 479

# combine AD and WT, irrespective of time point
lrt_cor_filtered <- rbind(
  lrt_cor_filtered_1,
  lrt_cor_filtered_2,
  lrt_cor_filtered_3,
  lrt_cor_filtered_4
