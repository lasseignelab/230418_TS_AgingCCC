...
bubbleplot_shared <- ggplot(fea_res_shared,
                            aes(x = condition,
...
png(here("results", "intermediate_outputs", "04_ccc", "fea_shared_bubbleplot.png"), dpi)
ggsave(here("results", "intermediate_outputs", "04_ccc", "fea_shared_bubbleplot.png"),
       bubbleplot_shared,
       dpi = 400,
       width = 8,
       height = 7,
