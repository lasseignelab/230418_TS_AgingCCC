...
author: "Tabea M. Soelter (Original code from JHW)"
date: "2024-02-11"
...
* The function calculating the targeting score was written by Jordan H. Whitlock
  * I created a wrapper to be able to run multiple networks at once
  * Detail on the function can be found in the function and in Whitlock et al. 2023
```{r}
